...
#define ccw 0
#ifndef ms1
#define ms1 St_PORTB0    //ms1 pin from the driver connect to portA0
#define ms2 St_PORTB1    //ms2 pin from the driver connect to portA1
#define ms3 St_PORTB2    //ms3 pin from the driver connect to portA2
#define StepA St_PORTB3  //step pin for first stepper from the driver connect to portA3
#define DIRA St_PORTB4   //direction pin for first stepper from the driver connect to portA4
